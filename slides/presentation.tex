  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[->,>=stealth',auto,node distance=3cm,
      ...
      \only<2->{
        ...
        (0) edge[aligned edge, onslide={<2>new}, onslide={<3>newtext}] node {$t_1$\only<3->{$: x \geq y$}} (1)
        (0) edge[aligned edge, onslide={<2>new}, onslide={<3>newtext}, bend right=25] node [below] {$t_2$\only<3->{$: y > x$}} (2)
        (1) edge[aligned edge, onslide={<2>new}, onslide={<3>newtext}, loop above, onslide={<5->scc1}] node {$t_3$\only<3->{$:$\\$i > 0 \wedge$\\$x' = x + 1 \wedge$\\$i' = i - 1$}} (1)
        (1) edge[aligned edge, onslide={<2>new}, onslide={<3>newtext}] node {$t_4$\only<3->{$: i = 0$}} (2)
        (2) edge[aligned edge, onslide={<2>new}, onslide={<3>newtext}, loop above, onslide={<5->scc2}] node {$t_5$\only<3->{$:$\\$x' = x + 1 \wedge$\\$y' = y + 1$}} (2)
        (2) edge[aligned edge, onslide={<2>new}, onslide={<4>newtext}] node {$t_6$\only<4->{, assert($x \neq y$)}} (4)
        (5) edge[aligned edge, onslide={<2>new}, onslide={<3>newtext}] node {$t_0$\only<3->{$: i > 0$}} (0);
      }
    \end{tikzpicture}
  \end{figure}
  \end{overlayarea}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[->,>=stealth',auto,node distance=3cm,
      ...
      edge [aligned edge, bend right=25,
        ...
        onslide={<19>changed}]
      node [below] {$t_2: y > x$\\\only<19->{$\wedge \mathbf{x \leq y}$}}
      (2)
      ...
      edge [aligned edge,
        ...
        onslide={<18>changed}, onslide={<18>safe},
        onslide={<21>changed}, onslide={<21-22>safe}]
      node {$t_4: i = 0$}
      (2)
      ...
      edge [aligned edge, loop above,
        ...
        onslide={<19>changed}]
      node {$t_5:$\\$x' = x + 1 \wedge$\\$y' = y + 1$\\\only<19->{$\wedge \mathbf{x \leq y}$}}
      (2)
