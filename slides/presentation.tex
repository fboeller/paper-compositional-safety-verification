...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[->,>=stealth',auto,node distance=2cm,
      ...
      \node[main node, onslide={<2->inspect}, onslide={<11>safe}] (0) {$l$};
      \node[main node, onslide={<3-5>inspect}, onslide={<6->safe}] (1) [above left of=0] {$l$};
      \node[main node, onslide={<7-9>inspect}, onslide={<10->safe}] (2) [below left of=0] {$l$};
      ...
      \path[every node/.style={font=\sffamily\small}]
        (1) edge[onslide={<3-5>inspect}, onslide={<6->safe}] node {} (0)
        (2) edge[onslide={<7-9>inspect}, onslide={<10->safe}] node {} (0)
        (11) edge[onslide={<4>inspect}, onslide={<5->safe}] node {} (1)
        (21) edge[onslide={<8>inspect}, onslide={<9->safe}] node {} (2)
        (0) edge[onslide={<2-10>inspect}, onslide={<11>safe}] node {} (exit);
    \end{tikzpicture}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \only<3-8>{
    \begin{block}{Max-SMT on $\lbrace \ell_2 \rbrace$ for $x \neq y$}
      \only<3>{$I_{\ell_2,1}(\lbrace x, y, i \rbrace) \equiv i_{\ell_2,1} + i_{\ell_2,1,x} * x + i_{\ell_2,1,y} * y + i_{\ell_2,1,i} * i \leq 0$}
